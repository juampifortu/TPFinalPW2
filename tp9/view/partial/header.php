...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card">
        ...
        <a href="index.php?page=inicio" class="w3-bar-item w3-button w3-padding-large">Inicio</a>
        <a href="index.php?page=registrarse" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Registrarse</a>
